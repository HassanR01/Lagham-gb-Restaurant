...
export default async function OrderList() {
    ...
    return (
        <>
            <div className="orders w-full p-8 flex justify-center items-center flex-col-reverse">
                    ...
                    <div className="order w-full p-2 border border-gray-400 rounded-xl my-4" key={order._id}>
                        <div className="titles  flex flex-row items-center justify-between">
                            ...
                            <div className="user">
                                ...
                                <h3 className='font-semibold text-xl'><span className='text-gray-400'>Phone:</span> {order.phoneNum}</h3>
                            </div>
                            <div className="price">
                                ...
                                {order.items.map((item, ind) => (
                                    <div className="item flex justify-around items-center my-4" key={ind}>
                                        <div className="quantity flex items-center justify-center">
                                            <Image className='rounded-xl mr-2' src={item.itemInfo.image} width={80} height={80} alt={item.itemInfo.titleAr} />
