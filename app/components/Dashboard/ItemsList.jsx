                ...
                <div className="items w-full p-4">
                    {items.length > 0 && items.map(item => (
                        <div className="item w-full  rounded-xl my-4 border-gray-500 border flex flex-col justify-between items-center duration-700" key={item._id}>
                            <div className="details w-full p-2 pl-16 flex flex-row justify-between items-center">

                                <div className="titles flex items-center justify-center">
                                    <Image src={item.image} className='ml-2 rounded-xl' width={80} height={80} alt={item.titleEn} />
                                    <div className="title">
                                ...
                                <div className="created text-xl flex items-center justify-center">
                                    <h3 className='ml-10'>{item.createdAt.slice(0, 10)}</h3>
